...
class VilleController extends Controller
{
     ...
     *
     * @Route("/", name="admindep_ville_index")
     * @Method("GET")
     */
     ...
     *
     * @Route("/new", name="admindep_ville_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admindep_ville_show', array('id' => $ville->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admindep_ville_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{id}/edit", name="admindep_ville_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Ville $ville)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admindep_ville_edit', array('id' => $ville->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admindep_ville_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, Ville $ville)
    {
        ...
        return $this->redirectToRoute('admindep_ville_index');
    }
    ...
    private function createDeleteForm(Ville $ville)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admindep_ville_delete', array('id' => $ville->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
